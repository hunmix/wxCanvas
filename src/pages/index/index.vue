...
export default {
  ...
  mounted () {
    ...
    // this.wxCanvas.add(this.image)
    // this.wxCanvas.add(this.circleImage)
    this.circle = new Shape('circle', {r: 100, locX: 'center', locY: 'center', color: '#ccc', fillMethod: 'fill'}, {dragable: true, scaleable: true})
    this.rect = new Shape('rect', {w: 200, h: 200, locY: 'center', locX: 'center', color: 'red', fillMethod: 'fill'}, {dragable: true, scaleable: true})
